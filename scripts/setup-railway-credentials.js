...
try {
    ...
    console.log('   Option A: Via Railway Dashboard');
    console.log('   - Go to your Railway project dashboard');
    console.log('   - Navigate to "Volumes" tab');
    console.log('   - Click on your volume and upload the files');
    console.log('');
    console.log('   Option B: Deploy with files in container');
    console.log('   mkdir -p credentials');
    console.log(`   cp "${LOCAL_OAUTH_PATH}" credentials/gcp-oauth.keys.json`);
    console.log(`   cp "${LOCAL_CREDENTIALS_PATH}" credentials/credentials.json`);
    console.log('');
